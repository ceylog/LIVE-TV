...
const sl = [
  {
    url: "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Ftindy/IPTV-URL/main/IPTV.m3u",
    name: "IPTV",
  },
  {
...
const options = reactive({
  ...
  sources: [
    {
      src: "https://live-play.cctvnews.cctv.com/cctv/merge_cctv13.m3u8",
